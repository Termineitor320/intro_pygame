...
# sonido de fondo 
SILBATO = pygame.mixer.music.load("soundd/silbato.ogg")
pygame.mixer.music.play(1,0,0)

# efectos sonoros 
GALLO = pygame.mixer.Sound("sounds/gallo.ogg")
CUERVO = pygame.mixer.Sound("sounds/cuervo.ogg")
BICI = pygame.mixer.Sound("sound/bici.ogg")

# bucle del juego 
while CONTINUAR:
    for event in pygame.event.get():
        # cierra la ventana si se hace click en el boton de cerrar en la ventana 
